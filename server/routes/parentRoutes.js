...
const { registerParent, getParents, getStudentsForParent } = require('../controllers/parentController');
...
// --- Routes ---
router.post('/login', parentLogin); // Public route for parents to log in
